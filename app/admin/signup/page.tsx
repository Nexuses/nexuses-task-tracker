    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-slate-50 flex items-center justify-center p-4">
      <Card className="w-full max-w-md border-2 border-blue-900 shadow-xl">
        <CardHeader className="bg-white p-6">
          ...
          <CardTitle className="text-2xl font-bold text-center text-slate-900">Admin Signup</CardTitle>
        ...
        <CardContent className="p-6">
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="text-center text-sm text-slate-600">
              ...
              <Link href="/admin/login" className="text-blue-900 hover:underline font-medium">
                Login
              </Link>
            </div>
          </form>
